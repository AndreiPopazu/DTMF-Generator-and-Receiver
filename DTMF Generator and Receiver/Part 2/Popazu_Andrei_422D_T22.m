...
T=10;                           %#input %perioada semnalului
P=T/2;                                  %jumatate de perioada
s=0;                            %#input %valoarea inferioara a intervalului
d=10;                           %#input %valoarea superioara a intervalului

%zona de definire a coeficientilor fourier
f(t) = sin(pi*t/10) ;           %#input %semnalul de intrare
...
for n=1:1:10
    ...
    if (n == 2 || n == 4 || n == 7 || n == 10)
        ...
        plot(t,sin(pi*t/10),'-k','LineWidth',1) %graficul semnalului de intrare
        hold on
